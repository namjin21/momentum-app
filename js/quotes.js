...
const authorElement = document.querySelector("#quote span:nth-child(2)");

quoteElement.innerHTML = quotes[Math.floor(Math.random() * quotes.length)].quote
authorElement.innerHTML = quotes[Math.floor(Math.random() * quotes.length)].author